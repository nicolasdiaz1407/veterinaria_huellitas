    ...
    <div>
      <div id="productos">
        ...
        <div class="boox">
          ...
          <h3>Alimentos</h3>
          <p>Descubre nuestra mejor selección de alimentos especialmente para tus mascotas.</p>
          <div class="view-more">
            <ul className="ver-pro">
              <li>
                <Link to="/alimentos"><button className="button-verpro">Ver mas</button></Link>
        ...
        <div class="boox">
          ...
          <h3>Jugueteria</h3>
          <p>
            Encuentra una variedad de juguetes divertidos para mantener a tu mascota
            entretenida.
          </p>
          <div class="view-more">
          <ul className="ver-pro">
              <li>
              <Link to="/juguetes"><button className="button-verpro">Ver mas</button></Link>
              </li>
            </ul>
      </div>
        </div>
        <div class="boox">
          ...
          <h3>Art. varios</h3>
          <p>
            Explora nuestra variedad de accesorios y productos para el cuidado
            de tu mascota.
          </p>
                <div class="view-more">
                <ul className="ver-pro">
              <li>
              <Link to="/artvarios"><button className="button-verpro">Ver mas</button></Link>
              </li>
            </ul>
      </div>
    </div>
